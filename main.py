...
player_size = (130, 80)
player = pygame.transform.scale(pygame.image.load('images/goose/1-5.png').convert_alpha(), player_size)   


player_rect = player.get_rect()
player_rect.topleft = (0, ((HEIGHT/2)-80)) #change goose position to center
...
def create_bonus():
    ...
    bonus_size = (80, 100)
    bonus = pygame.transform.scale(pygame.image.load('images/bonus.png'), bonus_size)
...
pygame.time.set_timer(CHANGE_IMAGE, 130)
